...
| WTS-018 | IN PROGRESS | Prepare the GitHub-based development workflow | Standalone Git repository, CI, iteration runbook, and implementation `RepoUrl` are ready | WTS-003 |
